...
namespace JA.Numerics.Simulation.Spatial.Geometry
{
    ...
    public class Mesh : ICanChangeUnits<Mesh>
    {
        ...
        #region Rendering
        public void Render(Graphics g, Camera camera, bool showMesh = false, float scale = 1)
            => Render(g, camera, Pose.Origin, showMesh, scale);
        public void Render(Graphics g, Camera camera, Pose pose, bool showMesh = false, float scale = 1)
        {
