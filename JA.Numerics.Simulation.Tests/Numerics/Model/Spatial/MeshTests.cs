...
using JA.Numerics.Model.Spatial;
using System;
...
namespace JA.Numerics.Model.Spatial.Tests
{
    using System.Collections;
    ...
    public class MeshTests
    {
        ...
        public void GetMmoiTest()
        {
            ...
            CollectionAssert.AreEqual(new[] { 0.2909014f, 0.8741418f, 1.123957f }, mmoi.ToArray(), tight);

            var R = Matrix3.CreateRotation(cm.Orientation);
            Vector3 axis_1 = R.Column1, axis_2 = R.Column2, axis_3 = R.Column3;

            CollectionAssert.AreEqual(new[] { -0.9465475f, 0.268339f, -0.1790036f }, axis_1.ToArray(), tight);
            CollectionAssert.AreEqual(new[] { 0.2970076f, 0.9415225f, -0.1591283f }, axis_2.ToArray(), tight);
            CollectionAssert.AreEqual(new[] { 0.1258356f, -0.203788f, -0.9708945f }, axis_3.ToArray(), tight);
        }
    }
}